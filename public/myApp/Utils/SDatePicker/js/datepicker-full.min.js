!(function () {
    ...
    const J = {
            ...
            es: {
                ...
                daysShort: ['Dom', 'Lun', 'Mar', 'Mier', 'Jue', 'Vie', 'Sáb'],
    ...
    function xe (e, t) {
        ...
        n
            ...
            : De(e, Number(1 === s ? a.month : a.year))
    }
    function Me (e) {
        e.preventDefault()
    }
    const Oe = ['left', 'top', 'right', 'bottom'].reduce(
    ...
    class Ee {
        ...
        render (e = !0) {
            ...
            if (
                ...
                e.getFullYear() !== n.getFullYear() && fe(i, 'changeYear'),
                    e.getMonth() !== n.getMonth() && fe(i, 'changeMonth')
            }
        }
    }
    ...
    function Ye (e, t) {
        ...
        'ArrowLeft' === r
            ...
            : 'ArrowDown' === r
            ? p(1, !0)
            : ('Backspace' === r || 'Delete' === r || (1 === r.length && !c)) &&
              e.enterEditMode()
    }
    function We (e) {
    ...
    function $e (e, t, i) {
        ...
        ;(l || o) &&
            (l && l.toString() !== e.dates.toString()
                ? ((e.dates = l), Ie(e, a ? 3 : 1, !0, c), fe(e, 'changeDate'))
                : Ie(e, d ? 3 : 1, !0, c),
            r && e.hide())
    }
    function Pe (e, t) {
        ...
        (window.DateRangePicker = class {
            constructor (e, t = {}) {
                ...
                i.forEach(e => {
                    ...
                    a[0].dates.length > 0
                        ? qe(this, { target: i[0] })
                        : a[1].dates.length > 0 && qe(this, { target: i[1] })
            }
            setOptions (e) {
