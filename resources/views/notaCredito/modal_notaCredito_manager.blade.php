...
<div class="modal fade" id="modal_change_notaCredito" ref="modal" tabindex="-1" aria-labelledby="modal_change_notaCredito" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 50rem">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_change_notaCredito"><b> Notas de crédito </b></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
