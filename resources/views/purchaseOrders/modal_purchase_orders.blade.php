<div class="modal fade" id="modal_purchase_order" ref="modal" tabindex="-1" aria-labelledby="modal_purchase_order_form" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 50rem">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_purchase_order_form"><b> @{{ modal_title }} </b></h5>
                            ...
                            <div class="form-group sm-form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" id="myDatePicker" ref="datepicker" name="datepicker" class="form-control">
                                        <div class="input-group-append">
                                            <button class="btn btn-sm btn-inverse-dark" type="button" v-on:click="openDeliveryDate()">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" v-on:click="saveDeliveryDate()"><b>Guardar</b></button>
            </div>
        </div>
    </div>
</div>